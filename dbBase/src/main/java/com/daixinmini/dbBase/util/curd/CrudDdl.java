...
public class CrudDdl {


    protected static <T> int delete(T t, Class clazz, JdbcTemplate jdbcTemplate) {
    ...
    protected static <T> void save(T t, Class clazz, JdbcTemplate jdbcTemplate) {
        ModelMeta meta = ModelMetaUtil.get(clazz);
